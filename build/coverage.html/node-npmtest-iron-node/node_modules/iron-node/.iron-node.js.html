...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-iron-node/node_modules/iron-node/.iron-node.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-iron-node/node_modules/iron-node/.iron-node.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-iron-node/node_modules/iron-node/</a> &#187; .iron-node.js</div>
</div>
<div class="body">
...
var settings = {
  ...
  "workSpaceDirectory"        : <span class="fstat-no" title="function not covered" >function(argv) {</span>  // determines the workspace directory for specific commandline applications.
...
<span class="cstat-no" title="statement not covered" >      result = path.dirname(argv[2]);</span>
<span class="cstat-no" title="statement not covered" >      var startupScriptName = path.basename(argv[2]).toLowerCase();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      switch(startupScriptName) {</span>
          case "_mocha":
<span class="cstat-no" title="statement not covered" >            result = process.cwd();</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          default:
<span class="cstat-no" title="statement not covered" >            result = path.resolve(result);</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
      }
    }
&nbsp;
